...
module.exports = {
  category: "Testing",
  description:
    "Server bans the player from server by UserId with for an optional period",
        ...
        return new discord.MessageEmbed()
          ...
          .setDescription(
            responseData.success
              ? `Player prompted to be server banned until ${expires} from serverId: ${jobId}`
              : "Unable to server ban the player"
          )
